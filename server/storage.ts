...
export const storage = {
  ...
  async updateUserEmail(id: number, email: string) {
    const instance = await initializeStorage();
    return instance.updateUserEmail(id, email);
  },
  async updateUserPassword(id: number, password: string) {
    const instance = await initializeStorage();
    return instance.updateUserPassword(id, password);
  },
  async getAllProfiles() {
    const instance = await initializeStorage();
    return instance.getAllProfiles();
  },
  async getProfile(id: number) {
    const instance = await initializeStorage();
    return instance.getProfile(id);
  },
  async createProfile(profile: InsertProfile) {
    const instance = await initializeStorage();
    return instance.createProfile(profile);
  },
  async updateProfile(id: number, profile: Partial<InsertProfile>) {
    const instance = await initializeStorage();
    return instance.updateProfile(id, profile);
  },
  async deleteProfile(id: number) {
    const instance = await initializeStorage();
    return instance.deleteProfile(id);
  },
  async searchProfiles(filters: any) {
    const instance = await initializeStorage();
    return instance.searchProfiles(filters);
  },
  async getProfilesByGender(gender: string) {
    const instance = await initializeStorage();
    return instance.getProfilesByGender(gender);
  },
  async createMatch(match: InsertMatch) {
    const instance = await initializeStorage();
    return instance.createMatch(match);
  },
  async getMatchesForProfile(profileId: number) {
    const instance = await initializeStorage();
    return instance.getMatchesForProfile(profileId);
  },
  async getRecentMatches() {
    const instance = await initializeStorage();
    return instance.getRecentMatches();
  },
  async getProfileStats() {
    const instance = await initializeStorage();
    return instance.getProfileStats();
  },
  async getCustomOptions(fieldType: string) {
    const instance = await initializeStorage();
    return instance.getCustomOptions(fieldType);
  },
  async createCustomOption(option: InsertCustomOption) {
    const instance = await initializeStorage();
    return instance.createCustomOption(option);
  },
  async deleteCustomOption(id: number) {
    const instance = await initializeStorage();
    return instance.deleteCustomOption(id);
  }
};e();
